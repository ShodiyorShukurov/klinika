				...
				<div className='bg-white rounded-2xl shadow-lg p-8 flex flex-col md:flex-row gap-8'>
					...
					<div className='flex-1'>
						<h2 className='text-3xl md:text-4xl font-bold text-[#041424] mb-4 leading-tight'>
							...
							sentr, Lor 24/7 Toshkent, Lor operasiya, Lazer sentr
						</h2>
						...
						<p className='mb-4 text-gray-700'>
							Otorinolaringolog (<span className='font-bold'>LOR</span>) –
							quloq, burun va tomoq kasalliklarini (halqum, traxeya, farenks)
							davolovchi shifokor. <span className='font-bold'>LOR</span>{' '}
							kasalliklarining asoratlari va surunkali shaklga o‘tish xavfini
							bartaraf etish uchun ularni o‘z vaqtida tashxislash muhimdir.{' '}
							<span className='font-bold'>LOR</span> 24/7 ning qismida siz
							malakali, tajribali otorinolaringologga o‘zingiz uchun qulay
							vaqtda, navbatlarsiz, so‘rovlar va tavsiyalarsiz tashrif
						...
						<div className='mb-4'>
							...
							alomatlar uchun <span className='font-bold'>LOR</span>{' '}
							shifokorining shoshilinch maslahati zarur:
							<ul className='mt-2 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 text-gray-800'>
								...
								<li className='flex items-center gap-2'>
									<span className='text-blue-600'>●</span> Eshitish va
									hidlashning buzilishi;
								</li>
								<li className='flex items-center gap-2'>
									<span className='text-blue-600'>●</span> Quloqlarda
									g‘ayrioddiy oqim, shovqin, og‘riq yoki bosim;
								</li>
								<li className='flex items-center gap-2'>
