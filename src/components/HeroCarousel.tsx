...
const SLIDES: Slide[] = [
  ...
  {
    id: 2,
    pretitleKey: "hero.slides.2.pretitle",
            ...
            <div className="lg:col-span-6">
              <div>
                <p className="text-[16px] leading-6 text-[#0c5adb] font-medium ">
                  {SLIDES[index].pretitleKey ? t(SLIDES[index].pretitleKey) : ""}
                </p>
                <h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-bold text-[#041424] leading-tight">
                  {t(SLIDES[index].titleKey)}
                </h1>
                <p className="hidden sm:block mt-6 text-[#6B7280] text-[20px] leading-6 font-medium">
                  {SLIDES[index].descriptionKey ? t(SLIDES[index].descriptionKey) : ""}
                </p>
                    ...
                    {SLIDES.map((_, i) => {
                      ...
                      const base =
                        i === index
                          ...
                          : "w-3 h-3 rounded-full border-2 border-blue-200";
                      return (
                        <button
                          key={i}
                          onClick={() => goTo(i)}
